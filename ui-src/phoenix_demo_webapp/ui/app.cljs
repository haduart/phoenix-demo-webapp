            ...
            [:div.container
             ...
             [:ul
              ...
              [:li [:p "Start making your webapp!"]
               [:ul
                [:li [:p "The CLJS entry point is in " [code "ui-src/phoenix_demo_webapp/ui/app.cljs"]]]
                [:li [:p "The Clojure Ring handler is in " [code "src/phoenix_demo_webapp/service/handler.clj"]]]]]
